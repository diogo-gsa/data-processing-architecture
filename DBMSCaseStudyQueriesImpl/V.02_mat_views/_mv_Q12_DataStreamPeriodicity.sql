CREATE MATERIALIZED VIEW "DBMS_EMS_Schema"."_mv_Q12_DataStreamPeriodicity" AS 
...
FROM    "DBMS_EMS_Schema"."_mv_Q00_DataAggregation" rela
        JOIN 
        "DBMS_EMS_Schema"."_mv_Q00_DataAggregation" relb 
        ON rela.device_pk = relb.device_pk 
        AND (rela.index + 1) = relb.index;

ALTER TABLE "DBMS_EMS_Schema"."_mv_Q12_DataStreamPeriodicity"
  OWNER TO postgres;