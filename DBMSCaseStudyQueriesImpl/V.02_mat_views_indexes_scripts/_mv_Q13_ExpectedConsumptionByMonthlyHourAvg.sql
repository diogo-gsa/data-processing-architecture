 CREATE MATERIALIZED VIEW "DBMS_EMS_Schema"."_mv_Q13_ExpectedConsumptionByMonthlyHourAvg" AS 
...
FROM 	(SELECT	pivot_measures.device_pk,
	...
	FROM 	"DBMS_EMS_Schema"."_mv_Q08_SquareMeterNormalization" cluster_measures
		JOIN 
		"DBMS_EMS_Schema"."_mv_Q08_SquareMeterNormalization" pivot_measures 
...
ALTER TABLE "DBMS_EMS_Schema"."_mv_Q13_ExpectedConsumptionByMonthlyHourAvg"
  OWNER TO postgres;