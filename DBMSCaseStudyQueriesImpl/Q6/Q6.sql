SELECT	device_pk, 
	...
	'Percent variation between current and expected consumption' 	AS measure_description, 
	device_location
FROM 	"DBMS_EMS_Schema"."Q14_CurrentAndExpectedUDFMeasure"
WHERE 	(measure/(expected_measure+0.0001) - 1)*100 > 10	-- +0.0001 to avoid division-by-zero
